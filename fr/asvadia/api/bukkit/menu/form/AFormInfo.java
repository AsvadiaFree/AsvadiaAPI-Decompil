...
public class AFormInfo implements AForm, ButtonForm {
  ModalForm form;
  
  AButtonComponent trueButton;
  
  AButtonComponent falseButton;
  
  public AFormInfo(ModalForm form, AButtonComponent trueButton, AButtonComponent falseButton) {
    this.form = form;
  ...
  public AButtonComponent getButtonResponse(String s) {
    if (this.form.parseResponse(s).getResult())
